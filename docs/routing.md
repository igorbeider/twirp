...
[Haberdasher service](https://github.com/igorbeider/twirp/wiki/Usage-Example:-Haberdasher)
the route would be:
...
[Protobuf and JSON](https://github.com/igorbeider/twirp/wiki/Protobuf-and-JSON)
for more details.
